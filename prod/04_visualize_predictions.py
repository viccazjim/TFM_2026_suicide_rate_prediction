"""
04 — Visualize predict.py output.
...
Usage:
    python prod/04_visualize_predictions.py
    python prod/04_visualize_predictions.py --predictions path/to/other_predictions.csv
...
def run(predictions_path: Path):
    ...
    logger.info("Loading historical data: %s", DEVELOPMENT_CSV_PATH)
    df_history = pd.read_csv(DEVELOPMENT_CSV_PATH)
