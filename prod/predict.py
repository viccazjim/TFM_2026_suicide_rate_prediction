...
Usage:
    ...
    # Score your own file (must have the same predictor columns as
    # data/processed/df_development.parquet, without "Suicide rate")
...
DEFAULT_OUTPUT_PATH = REPO_ROOT / "outputs" / "tables" / "predictions.parquet"
